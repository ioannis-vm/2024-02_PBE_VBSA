...
brace_core_areas[1] = 7.00  # in2
brace_core_areas[2] = 5.50  # in2
brace_core_areas[3] = 4.00  # in2


#   lvl: 1     2     3
coeff = [8, 8, 0, 4, 4, 3]  # beams  # columns
...
lvl_weight = dict(
    level_1=1180.508957 * 1e3, level_2=1165.462570 * 1e3, level_3=1268.918283 * 1e3
)  # lb
