"""
Design of a 3-story SCBF risk category IV system
"""
...
#   lvl: 1     2     3
coeff = [8, 5, 0, 7, 7, 7, 13, 13, 12]  # beams  # columns  # braces
...
lvl_weight = dict(
    level_1=1164.308019 * 1e3, level_2=1146.003591 * 1e3, level_3=1252.341283 * 1e3
)  # lb
