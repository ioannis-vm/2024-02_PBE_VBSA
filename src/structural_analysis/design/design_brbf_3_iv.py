...
brace_core_areas[1] = 5.75  # in2
brace_core_areas[2] = 4.25  # in2
brace_core_areas[3] = 3.00  # in2


#   lvl: 1     2     3
coeff = [8, 8, 0, 2, 2, 2]  # beams  # columns
...
lvl_weight = dict(
    level_1=1183.702260 * 1e3, level_2=1169.173019 * 1e3, level_3=1258.981032 * 1e3
)  # lb
